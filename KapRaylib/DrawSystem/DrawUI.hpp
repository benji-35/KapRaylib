            ...
            namespace Draw
            {
                ...
                class DrawSpriteColor : public RaylibDrawing
                {
                  public:
                    ...
                    float getHeigth() const { return _heigth; }
                    ...
                    void setHeigth(float h) { _heigth = h; }
                ...
                class DrawSpriteTexture : public RaylibDrawing
                {
                  public:
                    ...
                    DrawSpriteTexture(RaylibEncapsulation &e, std::string const &path, float x, float y, float w, float h, Color c)
                        : RaylibDrawing(e)
                    {
                        setPosX(x);
                        setPosY(y);
                    ...
                    Rectangle getRectangle() const { return _rect; }
                    ...
                    void setPathTexture(std::string const &path) { _path = path; }

                    void setRot(float r) { _rot = r; }

                    void setRectangle(Rectangle rect) { _rect = rect; }
